...
<html>
   <head>
      ...
      <script type="text/javascript"
         src="http://maps.google.com/maps/api/js?key=AIzaSyDAHMUroQQaGJvWPGGUIUEpInpGU72pk-4&sensor=false&v=3.21.5a&libraries=drawing&signed_in=true&libraries=places,drawing"></script>
   ...
   <body class="mainbody">
      ...
      <div id="panel">
         ...
         <div id="color-palette" ></div>
             <?php $zone_position = $this->db->get_where('zone', array('zone_id' => $zone_id))->row()->original_position; ?>
         <textarea id="cursel" readonly colls="100" style="height:100px;margin-bottom:20px;" class="margintop10 width100" row="30"><?php echo $zone_position; ?></textarea>
         <br>
         <button type="button" id="popmodal" onClick="saveData(<?php $zone_id; ?>)" class="btn btn-primary" style="margin:auto;display:block;width:134px;border:none;outline:0;">Save</button>
...
<script>
   ...
   function saveData(id){
       ...
       $.ajax({
               type: 'post',
               url: '<?php echo base_url(); ?>index.php/Zone/saveZone'+id,
               data: ({position: position, title: title}),
               dataType: 'html', 
               beforeSend: function() {
                    popupload();
                   },
