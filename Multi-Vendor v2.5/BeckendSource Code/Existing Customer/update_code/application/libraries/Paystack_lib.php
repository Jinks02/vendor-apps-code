...
class Paystack_lib
{
    ...
    public function __construct()
    {
       ...
       /* $this->test_secret_key = $this->CI->config->item('test_secret_key');
        ...
        $this->test_secret_key = $this->CI->db->get_where('general_settings',array('type'=>'paystack_secret'))->row()->value;
        $this->test_public_key = $this->CI->db->get_where('general_settings',array('type'=>'paystack_public'))->row()->value;
        $this->live_secret_key = $this->CI->db->get_where('general_settings',array('type'=>'paystack_secret'))->row()->value;
        $this->live_public_key = $this->CI->db->get_where('general_settings',array('type'=>'paystack_public'))->row()->value;
        $this->api_mode = 'TEST'; 
