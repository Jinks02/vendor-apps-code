         ...
         <div class="card mymarg">
            <div class="columncenter padding35">
               ...
               <div class="centercontentdiv margintop40">
                  <h5>Hey <?php echo $username;?></h5>
                  
                  <p class="greycolor fontweight400">To reset your password, enter this verification code <?php echo $optdata; ?>

                   <p>Thanks,</p>
                   <p><?php echo $this->db->get_where('general_settings', array('type' => 'system_name'))->row()->value; ?></p>
                   
                  </p>
                    <br>
                  <!--<p class="greycolor fontweight400">Use this code & reset your password</p> -->
                  <br>
