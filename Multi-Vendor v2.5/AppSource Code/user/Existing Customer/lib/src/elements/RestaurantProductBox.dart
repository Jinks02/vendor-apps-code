...
class RestaurantProductBox extends StatefulWidget {
  RestaurantProductBox({Key key,this.popperShow, this.choice, this.con, this.shopId, this.shopName, this.subtitle, this.km, this.shopTypeID, this.latitude, this.longitude, this.callback, this.focusId, this.shopDetails}) : super(key: key);
                          ...
                          child: Container(
                            ...
                            child: FlatButton(
                              onPressed: () {
                                ...
                                widget.con.addToCartRestaurant(widget.choice, 'cart',widget.choice.variant, widget.shopId, widget.choice.addon, shopName, subtitle, km, shopTypeId, latitude,longitude,widget.callback, widget.focusId);
