                  ...
                  _con.bookingDetailsList.isEmpty?EmptyOrdersWidget():Container(
                    ...
                    child: CustomPaginatedTable(
                      ...
                      dataColumns: [
                        ...
                        DataColumn(
                          label: Text(S.of(context).net_amount,style: Theme.of(context).textTheme.headline1,),
                        ),
                        DataColumn(
  ...
  DataRow getRow(int index) {
    ...
    return DataRow.byIndex(
      ...
      cells: <DataCell>[
        ...
        DataCell(Text(_con.bookingDetailsList[index].settlementValue ?? '',style: Theme.of(context).textTheme.subtitle2,)),
        DataCell(Text(_con.bookingDetailsList[index].commissionAmount ?? '',style: Theme.of(context).textTheme.subtitle2,)),
        DataCell(Text(_con.bookingDetailsList[index].totalAmount ?? '',style: Theme.of(context).textTheme.subtitle2,)),
