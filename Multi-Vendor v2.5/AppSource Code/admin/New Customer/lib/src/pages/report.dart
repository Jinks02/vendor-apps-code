...
class _ReportState extends StateMVC<Report>  {
  ...
  Widget build(BuildContext context) {
   /* List<ExcelExportModel> excelProperty = <ExcelExportModel>[
      ExcelExportModel(title: S.of(context).invoice_id, columnWidth: 15.82, bold: true),
      ExcelExportModel(title: S.of(context).item_amount, columnWidth: 20.82, bold: true),
      ExcelExportModel(title: S.of(context).settelment, columnWidth: 25.82, bold: true),
      ExcelExportModel(title: S.of(context).commission, columnWidth: 12.82, bold: true),
      ExcelExportModel(title: S.of(context).driver_commision, columnWidth: 12.82, bold: true),
      ExcelExportModel(title: S.of(context).driver_fees, columnWidth: 12.82, bold: true),
      ExcelExportModel(title: S.of(context).payment_method, columnWidth: 15.82, bold: true),
      ExcelExportModel(title: S.of(context).payment_status, columnWidth: 15.82, bold: true),
            ...
            child: Wrap(
              ...
              children: [
                Badge(
                  ...
                  badgeContent: Text(value, style: TextStyle(color: Theme.of(context).primaryColorLight)),
                ),
                ...
                Container(
                  ...
                  child:Column(
                    ...
                    children: [
                      ...
                      Text(setting.value.appName,style:Theme.of(context).textTheme.headline5.merge(TextStyle(color:Theme.of(context).primaryColorLight))),
                    ],
                  ),
                ),
                Container(
                                  ...
                                  children: [
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(height:10),
                                        Text(Helper.pricePrint(_con.summaryData.totalRevenue),style:Theme.of(context).textTheme.headline5.merge(TextStyle(color:Theme.of(context).primaryColorLight))),
                                        SizedBox(height:10),
                                        Text('${_con.summaryData.totalOrders} ${S.of(context).orders}',style:Theme.of(context).textTheme.subtitle2.merge(TextStyle(color:Theme.of(context).primaryColorLight))),
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(height:10),
                                        Text(Helper.pricePrint(_con.summaryData.thisMonthRevenue),style:Theme.of(context).textTheme.headline5.merge(TextStyle(color:Theme.of(context).primaryColorLight))),
                                        SizedBox(height:10),
                                        Text('${_con.summaryData.thisMonthOrders} ${S.of(context).orders}',style:Theme.of(context).textTheme.subtitle2.merge(TextStyle(color:Theme.of(context).primaryColorLight))),
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(height:10),
                                        Text(Helper.pricePrint(_con.summaryData.totalPaidCommission),style:Theme.of(context).textTheme.headline5.merge(TextStyle(color:Theme.of(context).primaryColorLight))),
                                        SizedBox(height:10),
                                        Text('${_con.summaryData.totalPaidOrders} ${S.of(context).orders}',style:Theme.of(context).textTheme.subtitle2.merge(TextStyle(color:Theme.of(context).primaryColorLight))),
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(height:10),
                                        Text(Helper.pricePrint(_con.summaryData.totalDueCommission),style:Theme.of(context).textTheme.headline5.merge(TextStyle(color:Theme.of(context).primaryColorLight))),
                                        SizedBox(height:10),
                                        Text('${_con.summaryData.totalDueOrders} ${S.of(context).orders}',style:Theme.of(context).textTheme.subtitle2.merge(TextStyle(color:Theme.of(context).primaryColorLight))),
