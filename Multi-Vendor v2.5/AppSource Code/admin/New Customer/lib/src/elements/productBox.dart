...
class ProductBox extends StatefulWidget {
  ...
  const ProductBox(
      {Key key, this.choice, this.con, this.pageType, this.productDetails, this.shopType})
      : super(key: key);
  @override
                    ...
                    Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                      ...
                      InkWell(
                        onTap: () async {
                          ...
                          // ignore: deprecated_member_use
                          url =
                              '${GlobalConfiguration().getValue('api_base_url')}api_vendor/export_action/my_variantlist/${currentUser.value.id}/${ widget.shopType}?$_apiToken';
                    ...
                    Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                      ...
                      InkWell(
                        onTap: () async {
                          ...
                          // ignore: deprecated_member_use
                          url =
                              '${GlobalConfiguration().getValue('api_base_url')}api_vendor/export_action/my_addons/${currentUser.value.id}/${   widget.shopType }?$_apiToken';
